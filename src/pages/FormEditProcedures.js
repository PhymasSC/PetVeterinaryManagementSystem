export function FormEditProcedures() {
  return (
    <div className="bg-teal-50 w-[93%]">
      <div className="flex justify-between">
        <h1 className="font-medium text-2xl ml-10 pt-12 pb-10">Edit Procedure</h1>
        ...
        <form action="get" className="flex flex-col items-center py-12">
          <div className="pb-10 ">
            <tr>
              ...
              <td>
                <input type="text" className="rounded-lg w-[20rem] lg:w-[40rem] h-8 px-3 py-4 border-2 border-gray-300" />
              </td>
            </tr>
          </div>
          <div>
